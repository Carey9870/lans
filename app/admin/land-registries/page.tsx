// app/admin/land-registries/page.tsx
import { Suspense } from "react";
import RegistriesClient from "./registries-client";

import { Spinner } from "@/components/ui/spinner";

export default function AdminLandRegistriesPage() {
  return (
...
// export default function AdminLandRegistries() {
...
//                       <div key={i} className="border border-gray-300 dark:border-gray-700 rounded-lg p-4 relative">
//                         <Input
...
//                     ))}
//                   </div>
//                   <Button onClick={addLocation} variant="outline" size="sm" className="mt-4">
...
//             <AlertDialogDescription>
//               This action cannot be undone. This will permanently delete the registry and all its locations.
//             </AlertDialogDescription>
//           </AlertDialogHeader>
//           <AlertDialogFooter>
